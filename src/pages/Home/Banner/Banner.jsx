      ...
      <Container className="grid lg:grid-cols-2 gap-16 items-center">
        <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
          ...
          <div className="flex flex-wrap gap-5">
            ...
            <Link
              to="/map-view"
              className="px-8 py-4 bg-surface-container-high text-primary font-bold rounded-lg hover:bg-surface-container-highest transition-all flex items-center gap-2"
            >
              <MapIcon size={20} />
              View Map
            </Link>
        ...
        >
          ...
          {loading ? (
            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-indigo-950 via-blue-900 to-primary p-8 text-white shadow-2xl lg:rotate-2">
              ...
              <div className="relative mt-8 flex items-center gap-6">
                ...
                >
                  <div className="flex h-24 w-24 flex-col items-center justify-center rounded-full bg-blue-950">
